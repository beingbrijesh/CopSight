  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        white: {
          panel: "hsl(var(--white-panel))",
          border: "hsl(var(--white-border))",
          shadow: "hsl(var(--white-shadow))",
        },
      },
      backgroundImage: {
      ...
      keyframes: {
        ...
        "glow": {
          '0%': { boxShadow: '0 0 20px hsl(var(--accent-orange))' },
          '100%': { boxShadow: '0 0 40px hsl(var(--accent-orange)), 0 0 60px hsl(var(--accent-orange))' },
        },
      },
    },
  },
