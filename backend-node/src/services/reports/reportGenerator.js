  ...
  try {
    ...
    const doc = new PDFDocument({
      ...
      info: {
        ...
        Creator: 'CopSight AI Report Generator'
      }
    });
...
function addHeader(doc, caseData) {
  ...
  doc.fontSize(24)
     .fillColor('#1e40af')
     .text('CopSight AI FORENSIC REPORT', { align: 'center' })
     .moveDown(0.5);
...
function addFooter(doc, caseData) {
  ...
  for (let i = 0; i < pages.count; i++) {
    ...
    doc.fontSize(8)
       .fillColor('#666666')
       .text(
         `Case ${caseData.caseNumber} | Page ${i + 1} of ${pages.count} | Generated by CopSight AI`,
         50,
         775,
